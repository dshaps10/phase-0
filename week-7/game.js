...
console.log("You have $100, 100 stamina and 0 hunger");
...
prompt("You wake up, throw on some clothes and walk outside.  You wonder whether you should take BART or just call an uber to the city.  Which do you choose?")
// Refactored Code
